...
bbh_fa = mknew_faa(query + '_psi-nonbbh.faa') # sequences of psiblast-blastp hits will be stored here
psi_fa = mknew_faa(query + '_psi-unique.faa') # sequences of unique psiblast hits will be stored here

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# EXTRACT THE SACC.VERS AND APPEND:
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

#filter to just get the sacc.ver list 
